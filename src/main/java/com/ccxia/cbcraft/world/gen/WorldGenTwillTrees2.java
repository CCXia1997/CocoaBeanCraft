...
public class WorldGenTwillTrees2 extends WorldGenAbstractTree {
    ...
    public WorldGenTwillTrees2(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public WorldGenTwillTrees2(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines)
    {
        super(notify);
