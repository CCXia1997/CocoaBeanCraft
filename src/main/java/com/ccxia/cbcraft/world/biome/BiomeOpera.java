...
public class BiomeOpera extends BiomeSavanna {
	...
	public BiomeOpera(BiomeProperties properties) {
		super(properties);
		this.setRegistryName("opera_plateau");
		this.topBlock = ModBlocks.OPERA_BLOCK.getDefaultState();
		...
		// 一些配置
		this.decorator.treesPerChunk = CbCraftConfig.horizontal_tree_amount;
