...
public class CocoaBiomes {
    ...
    public static final Biome COCOA_RIVER = new BiomeCocoaRiver((new Biome.BiomeProperties("Cocoa River")).setBaseHeight(-0.5F).setHeightVariation(0.0F));
    public static final Biome COCOA_OCEAN = new BiomeCocoaOcean((new Biome.BiomeProperties("Cocoa Ocean")).setBaseHeight(-1.0F).setHeightVariation(0.1F));
}
