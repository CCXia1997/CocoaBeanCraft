...
public class ContainerAutoCrushing extends Container {
	private IItemHandler upItems;;
	// private IItemHandler sideItems;
	private IItemHandler downItems;
	private TileEntityAutoCrushing tileEntity;

	// private int cocoaPower;
	private int crushTime;

	public ContainerAutoCrushing(EntityPlayer player, TileEntity tileEntity) {
		super();
		...
		this.tileEntity = (TileEntityAutoCrushing) tileEntity;
	}
	...
	public void detectAndSendChanges() {
		...
		this.crushTime = tileEntity.getCrushTime();
		for (IContainerListener i : this.listeners) {
			i.sendWindowProperty(this, 0, this.crushTime);
		}
	}
