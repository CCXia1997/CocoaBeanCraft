...
public class BlockHorizontalChocolateLeaves extends BlockLeaves {
	public BlockHorizontalChocolateLeaves() {
		super();
		this.setUnlocalizedName(CbCraft.MODID + ".horizontalChocolateLeaves");
		this.setRegistryName("horizontal_chocolate_leaves");
