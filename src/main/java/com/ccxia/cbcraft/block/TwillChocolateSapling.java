...
public class TwillChocolateSapling extends BlockBush implements IGrowable {
	...
	public TwillChocolateSapling() {
		super();
		this.setUnlocalizedName(CbCraft.MODID + ".twillChocolateSapling");
	...
	public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state) {
		WorldGenerator treeGenerator = new WorldGenTwillTrees(false);
	...
	protected boolean canSustainBush(IBlockState state) {
		...
		return block == ModBlocks.SCHWARZWAELDER_BLOCK || block == Blocks.GRASS || block == Blocks.DIRT
