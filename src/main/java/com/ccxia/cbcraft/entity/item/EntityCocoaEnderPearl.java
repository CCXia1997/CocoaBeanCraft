package com.ccxia.cbcraft.entity.item;
...
public class EntityCocoaEnderPearl extends EntityEnderPearl {

	private EntityLivingBase perlThrower;

	public EntityCocoaEnderPearl(World worldIn) {
		super(worldIn);
	}

	public EntityCocoaEnderPearl(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
		this.perlThrower = throwerIn;
	}

	@SideOnly(Side.CLIENT)
	public EntityCocoaEnderPearl(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}
...
//						}
						...
						// 传送玩家后给予玩家3秒的速度3和生命恢复3
						entityplayermp.addPotionEffect(new PotionEffect(MobEffects.SPEED, 90, 2));
						entityplayermp.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 90, 2));
					}
				}
