...
import com.ccxia.cbcraft.api.recipe.AutoPressingRecipe;
...
public class AutoPressingMaker {
    public static List<SimpleRecipe> getRecipes(IJeiHelpers helpers) {
        ...
        for (Map.Entry<Object[], ItemStack[]> entry : AutoPressingRecipe.instance().RecipesList.entrySet()) {
