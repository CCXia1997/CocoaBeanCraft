...
import com.ccxia.cbcraft.api.recipe.InjectionTableRecipe;
...
public class InjectionTableMaker {
    public static List<SimpleRecipe> getRecipes(IJeiHelpers helpers) {
        ...
        for (Map.Entry<Object[], ItemStack[]> entry : InjectionTableRecipe.instance().RecipesList.entrySet()) {
