...
public class CategoryCrush implements IRecipeCategory<IRecipeWrapper> {
    protected final IDrawable background;
    private final IDrawable icon;

    public CategoryCrush(IGuiHelper helper){
        ...
        this.icon = helper.createDrawableIngredient(new ItemStack(ModBlocks.CRUSHING_GRINDING_MACHINE));
    ...
    public String getTitle() {
        return I18n.format("jei.cbcraft.category.crush", new Object[0]);
    }
