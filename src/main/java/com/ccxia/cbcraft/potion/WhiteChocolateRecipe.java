...
public class WhiteChocolateRecipe implements IBrewingRecipe {
    @Override
    ...
    public boolean isIngredient(@Nonnull ItemStack ingredient) {
        return ingredient.getItem() == ModItems.WHITE_CHOCOLATE;
    }
    ...
    public ItemStack getOutput(@Nonnull ItemStack input, @Nonnull ItemStack ingredient) {
        if (isInput(input) && isIngredient(ingredient)) {
            ...
            potion.add(new PotionEffect(oldPotion.getPotion(), oldPotion.getDuration() * 3,
                    oldPotion.getAmplifier(), oldPotion.getIsAmbient(), oldPotion.doesShowParticles()));
            ...
            return PotionUtils.addPotionToItemStack(PotionUtils.appendEffects(input.copy(), potion), PotionTypes.WATER).
                    setStackDisplayName(input.getDisplayName() + "-" + I18n.translateToLocal("potion.whiteStrength"));
        }
