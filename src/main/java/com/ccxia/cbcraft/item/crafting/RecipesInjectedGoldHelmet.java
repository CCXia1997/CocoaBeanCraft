...
public class RecipesInjectedGoldHelmet extends Impl<IRecipe> implements IRecipe {

	private List<ItemStack> recipes1 = new ArrayList<ItemStack>();
	private List<ItemStack> recipes2 = new ArrayList<ItemStack>();

	public RecipesInjectedGoldHelmet() {
		this.setRegistryName("recipes_injected_gold_helmet");
		// 1#
