...
public class RecipesInjectedGoldAxe extends Impl<IRecipe> implements IRecipe {
    ...
    public RecipesInjectedGoldAxe() {
        this.setRegistryName("recipes_injected_gold_axe");
        // 1#
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        ...
        // 锋利7+效率5+耐久5+精修
        axe.addEnchantment(Enchantments.SHARPNESS, 7);
        axe.addEnchantment(Enchantments.EFFICIENCY, 5);
        axe.addEnchantment(Enchantments.UNBREAKING, 5);
