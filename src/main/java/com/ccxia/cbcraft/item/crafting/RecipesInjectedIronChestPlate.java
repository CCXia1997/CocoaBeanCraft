...
public class RecipesInjectedIronChestPlate extends Impl<IRecipe> implements IRecipe {

	private List<ItemStack> recipes = new ArrayList<ItemStack>();

	public RecipesInjectedIronChestPlate() {
		this.setRegistryName("recipes_injected_iron_chestplate");
