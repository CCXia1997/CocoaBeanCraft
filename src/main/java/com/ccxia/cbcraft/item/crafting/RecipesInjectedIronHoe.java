...
public class RecipesInjectedIronHoe extends Impl<IRecipe> implements IRecipe {
	...
	public RecipesInjectedIronHoe() {
		this.setRegistryName("recipes_injected_iron_hoe");
		// 1#
